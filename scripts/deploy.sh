...
[ -n "${APP_DOMAIN:-}" ] && echo -e "  Public : https://${APP_DOMAIN} (après setup_https.sh)"
echo ""
...
echo -e "  4. Activer le HTTPS : bash ${APP_DIR}/scripts/setup_https.sh"
echo ""
